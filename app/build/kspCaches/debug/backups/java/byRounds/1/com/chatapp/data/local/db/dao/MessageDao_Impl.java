...
public final class MessageDao_Impl implements MessageDao {
  ...
  public MessageDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfMessageEntity = new EntityInsertionAdapter<MessageEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `messages` (`id`,`conversation_id`,`role`,`content`,`thinking`,`timestamp`,`status`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        if (entity.getThinking() == null) {
          ...
          statement.bindString(5, entity.getThinking());
        }
    ...
    this.__preparedStmtOfUpdateContent = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE messages SET content = ?, thinking = ?, status = 'COMPLETE' WHERE id = ?";
        return _query;
      }
    };
  ...
  @Override
  public Object updateContent(final long id, final String content, final String thinking,
    ...
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      ...
      public Unit call() throws Exception {
        ...
        if (thinking == null) {
          ...
          _stmt.bindString(_argIndex, thinking);
        }
        _argIndex = 3;
  ...
  @Override
  public Flow<List<MessageEntity>> getByConversation(final long conversationId) {
      ...
      public List<MessageEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new MessageEntity(_tmpId,_tmpConversationId,_tmpRole,_tmpContent,_tmpThinking,_tmpTimestamp,_tmpStatus);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getRecent(final long conversationId, final int limit,
      final Continuation<? super List<MessageEntity>> $completion) {
    final String _sql = "SELECT * FROM messages WHERE conversation_id = ? ORDER BY timestamp DESC LIMIT ?";
