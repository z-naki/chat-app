...
public final class ConversationDao_Impl implements ConversationDao {
  ...
  public ConversationDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfConversationEntity = new EntityInsertionAdapter<ConversationEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `conversations` (`id`,`title`,`provider`,`created_at`,`updated_at`) VALUES (nullif(?, 0),?,?,?,?)";
      }
    ...
    this.__preparedStmtOfUpdateTitle = new SharedSQLiteStatement(__db) {
      ...
      public String createQuery() {
        final String _query = "UPDATE conversations SET title = ?, updated_at = ? WHERE id = ?";
        return _query;
      }
    };
  ...
  @Override
  public Object updateTitle(final long id, final String title, final long updatedAt,
      ...
      public List<ConversationEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new ConversationEntity(_tmpId,_tmpTitle,_tmpProvider,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public ConversationEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new ConversationEntity(_tmpId,_tmpTitle,_tmpProvider,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
